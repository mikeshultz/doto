...
function Events(props) {
  ...
  return (
    <div id="events">
      {authNotices}
      <ul className="events-container today">{todaysEvents}</ul>
      <ul className="events-container tomorrow">{tomorrowsEvents}</ul>
      <ul className="events-container future">{laterEvents}</ul>
